...
Working repository for [Robert Peake](https://www.robertpeake.com)'s research and projects on humane protocols for the transhuman age.
...
See: [The Infinite Game of Poetry](https://www.robertpeake.com/archives/103816-the-infinite-game-of-poetry.html)

## The Prufrock Protocol

A protocol for marking time through authentic responses to random interruptions. Pitch in development for [The Long Now Foundation](https://longnow.org/) Lab 001.1 — *Book of Time* — in conversation with the [Protocols Institute](https://summerofprotocols.com/protocols-institute). Submission: 2026-06-05.

See: [The Prufrock Protocol](prufrock/README.md)
...
See: [Protocols for Effective Human-AI Collaboration](transhuman-protocols/README.md)
