...
related:
  - fptsig-references.md         # thematic grouping (companion view)
  - fptsig-urls-with-context.txt # raw URL list with citing-line context
...
> Aggregate of ~14 papers in `Process Calculi.md` (see `fptsig-references.md` §3 for the full URL list).
