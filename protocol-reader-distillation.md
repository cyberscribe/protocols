...
related:
  - protocol-reader-citations.md     # filtered bibliography from the volume's consolidated notes
...
The companion file `protocol-reader-citations.md` carries 63 filtered citations (40 high, 23 medium) from the volume's *Consolidated Notes* section, deduplicated against this distillation's "citations to chase" lines so they don't repeat verbatim.
